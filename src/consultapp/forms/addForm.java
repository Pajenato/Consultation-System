...
public class addForm extends javax.swing.JFrame {
    ...
    public void insertRecord() {
        ...
        // Using first name, last name, and middle initial
        try {
            PreparedStatement existingPatientQuery = con
                    .prepareStatement("select * from qpd_doc where lastname = '"
                            + lastName
                            + "' AND firstname = '" + firstName
                            + "' AND MI = '" + middleInitial + "'");
            ResultSet result = existingPatientQuery.executeQuery();
            
            if (!result.next()) {
                try {
                    String insertQuery = "insert into qpd_doc ("
                            + "fullname1, fullname2, firstname, MI, lastname, address, age,"
                            + " gender, contact, famhis, pastmedhis, allergies, meds, date,"
                            + " findings, diagnosis, added, date_of_birth) values ('"
                            + fullNameLastFirst
                            + "','"
                            + fullNameFirstLast + "','"
                            + firstName + "','"
                    ...
                    PreparedStatement insertQueryStatement = con.prepareStatement(insertQuery);
                    insertQueryStatement.executeUpdate();
                    JOptionPane.showMessageDialog(null, "Added patient record.");
