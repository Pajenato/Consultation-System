 ...
 * @author User
 */
public class docPatientsRecords extends javax.swing.JFrame {

    /**
     * Creates new form patients
     */
    public docPatientsRecords() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(docPatientsRecords.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new docPatientsRecords().setVisible(true);
            }
        });
    }
